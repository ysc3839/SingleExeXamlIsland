...
public:
    ...
    {
        UINT32 bufferLength{};
        const LONG rc{ MddGetPackageInfo1Or2(packageInfoReference, flags, packagePathType, &bufferLength, nullptr, nullptr) };
        ...
        UINT32 count{};
        THROW_IF_WIN32_ERROR(MddGetPackageInfo1Or2(packageInfoReference, flags, packagePathType, &bufferLength, buffer.get(), &count));
